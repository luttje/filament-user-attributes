...
*For a complete example of a Livewire component see [the test mock component here](https://github.com/luttje/filament-user-attributes/blob/filament-v3/tests/Fixtures/Livewire/ConfiguredManageComponent.php).*
